#!/usr/bin/env python3
"""
Yoga Wiki Batch v8 - 26 new yoga poses × 3 languages = 78 pages
Generates 26 poses not yet in the wiki
"""
...
# 26 new poses for Batch v8
NEW_POSES = [
    # Standing & Balance
    ("Standing Forward Bend Variation", "standing-forward-bend-variation"),
    ("Wide Knee Child's Pose", "wide-knee-childs-pose"),
    ("Rabbit Pose", "rabbit-pose"),
    ("Half Camel Pose", "half-camel-pose"),
    ("Legs Up Chair Pose", "legs-up-chair-pose"),
    ("Seated Mountain Pose", "seated-mountain-pose"),
    ("Thunderbolt Pose Variation", "thunderbolt-pose-variation"),
    ("Cow Face Forward Fold", "cow-face-forward-fold"),
    # Arm Balances
    ("Mermaid Pose", "mermaid-pose"),
    ("Crane Pose Variation", "crane-pose-variation"),
    ("Side Crow Variation", "side-crow-variation"),
    # Hip Openers & Binds
    ("Dragon Pose Yin", "dragon-pose-yin"),
    ("Melting Heart Pose Variation", "melting-heart-pose-variation"),
    ("Banana Pose Yin", "banana-pose-yin"),
    ("Caterpillar Pose Yin", "caterpillar-pose-yin"),
    ("Squat Sequence", "squat-sequence"),
    ("Hip Circle Flow", "hip-circle-flow"),
    # Restorative & Yin
    ("Supported Shoulder Stand", "supported-shoulder-stand"),
    ("Gentle Twists Sequence", "gentle-twists-sequence"),
    ("Yin Restorative Sequence", "yin-restorative-sequence"),
    # Pranayama & Advanced
    ("Breath Awareness Meditation", "breath-awareness-meditation"),
    ("Seated Spinal Twist Variation", "seated-spinal-twist-variation"),
    ("Gentle Morning Sequence", "gentle-morning-sequence"),
    ("Cooling Evening Sequence", "cooling-evening-sequence"),
    ("Chakra Alignment Flow", "chakra-alignment-flow"),
    ("Heart Opening Sequence", "heart-opening-sequence"),
    ("Grounding Root Sequence", "grounding-root-sequence"),
]
